...
\hline
\end{tabular}
\caption{Human action classification performances in the Composable Activities
dataset.}
...
\hline
\end{tabular}
\caption{Action classification performances in the sub-JHMDB dataset.}
\label{tab:subjhmdb}
\end{table}
...
\hline
\end{tabular}
\caption{Atomic action annotation performances in the Composable Activities
